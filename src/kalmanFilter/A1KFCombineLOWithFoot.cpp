...
A1KFCombineLOWithFoot::A1KFCombineLOWithFoot() : A1KF()
{
    ...
    upper_leg_length[0] = upper_leg_length[1] = upper_leg_length[2] = upper_leg_length[3] = 0.25;
    lower_leg_length[0] = lower_leg_length[1] = lower_leg_length[2] = lower_leg_length[3] = 0.25;
...
void A1KFCombineLOWithFoot::update_filter(A1SensorData data)
{
    ...
    for (int i = 0; i < NUM_LEG; ++i)
    {
        ...
        measure_noise.block<3, 3>(i * 3, i * 3) = 0.0001 * eye3; // fk estimation
