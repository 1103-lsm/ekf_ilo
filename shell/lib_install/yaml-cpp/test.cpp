...
int main(int argc,char** argv)
{
    ...
    // config = YAML::LoadFile("/home/ray/Workspace/ros_workspace/quadruped_robot/src/aliengo_odometry/shell/lib_install/yaml-cpp/build/config.yaml");
    // config = YAML::LoadFile("/home/ray/Workspace/ros_workspace/quadruped_robot/src/aliengo_odometry/shell/lib_install/yaml-cpp/config.yaml");
    try{
